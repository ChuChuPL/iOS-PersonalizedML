...
knn_builder = KNearestNeighborsClassifierBuilder(input_name="features",
                                                 ...
                                                 default_class_label="keine Trainingsdaten",
...
knn_builder.set_number_of_neighbors_with_bounds(6, allowed_range=(1, 10))
...
coremltools.utils.save_spec(pipeline_spec, "../Models/Personalized6kNN.mlmodel")
