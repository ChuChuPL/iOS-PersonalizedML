...
class EvaluateViewController {
  ...
  var predictions: [Prediction?] = []//brauche ich nicht TODO
...
//    }
  ...
  override func viewWillDisappear(_ animated: Bool) {
    ...
    predictor.shouldCancel = true//Linh sollte canceln, wenn der Typ neues Bild auswählen möchte
  }

  // MARK: - Table view data source
//das ist nur, wenn ich "true label" habe
